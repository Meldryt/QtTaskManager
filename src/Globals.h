...
public:
    ...
    enum SysInfoAttr : uint8_t
    {
        ...
        Key_Network_Dynamic_Names,
        Key_Network_Dynamic_BytesReceivedPerSec,
        Key_Network_Dynamic_BytesSentPerSec,
        Key_Network_Dynamic_TotalBytesPerSec,
        Key_Network_Dynamic_CurrentBandwidth,
        Key_Network_Dynamic_End,

        Key_Process_Dynamic_Start,
        Key_Process_Dynamic_Names,
        Key_Process_Dynamic_Descriptions,
        Key_Process_Dynamic_FilePaths,
        Key_Process_Dynamic_States,
        Key_Process_Dynamic_RamUsagesPercent,
        Key_Process_Dynamic_CpuUsagesPercent,
        Key_Process_Dynamic_GpuUsagesPercent,
        Key_Process_Dynamic_VideoRamUsagesPercent,
        Key_Process_Dynamic_RamUsagesSize,
        Key_Process_Dynamic_VirtualRamUsagesSize,
        Key_Process_Dynamic_VideoRamUsagesSize,
        Key_Process_Dynamic_TimeStamps,
        Key_Process_Dynamic_Info,
        Key_Process_End_Start,
